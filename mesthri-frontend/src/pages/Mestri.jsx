...
export default function Mestri() {
  ...
  async function register(e) {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/auth/register`, {
        ...
        body: JSON.stringify({ name, phone, password, location, service, role: "MESTRI" }),
      });
    ...
    <div className="min-h-screen bg-rainbow">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-64px)] p-4">
        <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md">
          <h1 className="text-2xl font-bold mb-6 text-center text-purple-600">Mestri</h1>
          ...
          {tab === "register" ? (
            <form onSubmit={register} className="space-y-4">
              ...
              <input className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
                placeholder="Service (e.g. masonry)" value={service} onChange={(e) => setService(e.target.value)} required />
